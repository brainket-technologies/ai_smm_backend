...
async function main() {
  ...
  const platformList = [
    ...
    { name: 'Instagram', nameKey: 'instagram', logo: 'https://upload.wikimedia.org/wikipedia/commons/e/e7/Instagram_logo_2016.svg', url: 'https://instagram.com', isActive: true, appId: '1275710720811339', appSecret: '119be37282a98f5aae5e5e43bdad2721', scopes: 'instagram_business_basic,instagram_business_content_publish,instagram_business_manage_comments,instagram_business_manage_insights,instagram_business_manage_messages' },
    ...
    { name: 'LinkedIn', nameKey: 'linkedin', logo: 'https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png', url: 'https://linkedin.com', isActive: true, appId: '86pvpeh7kvvp80', appSecret: 'WPL_AP1.' + 'RkRPlQL5a6Yl4wyD.' + 'EU0n6w==' },
    { name: 'Google Business', nameKey: 'gmb', logo: 'https://www.gstatic.com/images/branding/product/2x/googleg_48dp.png', url: 'https://business.google.com', isActive: true, appId: '207598802549-' + 'ui5e1nl47i8pe9tm501t0eci5ohgjf97.apps.googleusercontent.com', appSecret: 'GOCSPX-' + 'R_X2b5inNjSNLwI4GC_ZrRETBH3y' },
    { name: 'YouTube', nameKey: 'youtube', logo: 'https://upload.wikimedia.org/wikipedia/commons/4/4c/YouTube_icon.png', url: 'https://youtube.com', isActive: true, appId: '207598802549-' + 'ui5e1nl47i8pe9tm501t0eci5ohgjf97.apps.googleusercontent.com', appSecret: 'GOCSPX-' + 'R_X2b5inNjSNLwI4GC_ZrRETBH3y' },
    { name: 'X (Twitter)', nameKey: 'twitter', logo: 'https://upload.wikimedia.org/wikipedia/commons/5/53/X_logo_2023_original.svg', url: 'https://twitter.com', isActive: true, appId: 'd2lXaGlkVVFKMW5oRS1yNjNlZno6MTpjaQ', appSecret: 'hJhiMnY21TQT' + '0on4rkP_' + '9nF7zfbFJfzn' + 'AnqOjlDOL2VXm0n5MD' },
