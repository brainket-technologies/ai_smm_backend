...
async function main() {
  ...
  const platformList = [
    ...
    { name: 'LinkedIn', nameKey: 'linkedin', logo: 'https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png', url: 'https://linkedin.com', isActive: true, appId: '86z2gktc33kiw8', appSecret: 'WPL_AP1.' + 'FQqSLZDX0Nm3319G.' + '4sRlgg==' },
