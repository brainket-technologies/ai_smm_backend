...
export class SocialMediaService {
  ...
  static async getInstagramAuthUrl(businessId: string, redirectUri: string) {
    ...
    // Use the Facebook-based OAuth dialog for professional Instagram Graph API permissions.
    // Even with a standalone Instagram App ID, this is the most reliable endpoint for Business Login.
