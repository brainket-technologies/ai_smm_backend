...
export default function PaymentsManagementClient({ initialPaymentMethods }: { initialPaymentMethods: any[] }) {
  ...
  const normalizedPayments = initialPaymentMethods.map(pm => ({ ...pm, id: pm.id.toString() }));
  const [paymentMethods, setPaymentMethods] = useState(normalizedPayments);
                ...
                <tr key={pm.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-center">
                    <button 
                      ...
                      className={cn(
                        ...
                        pm.isActive ? "bg-green-600" : "bg-slate-200 dark:bg-slate-700"
                      )}
                    >
                      <span className={cn(
                  ...
                  <td 
                    ...
                    className={cn(
                      ...
                      !pm.isDefault ? "cursor-pointer hover:bg-blue-50/50" : ""
                    )}
                  >
